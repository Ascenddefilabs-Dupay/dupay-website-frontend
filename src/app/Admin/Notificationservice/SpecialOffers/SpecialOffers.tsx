...
const SpecialOffers: React.FC = () => {
  const [activities, setActivities] = useState<AdminSpecialOffers[]>([]);
  ...
  const notifyEveryone = async (content_id: string) => {
    try {
      ...
      const message = response.data.special_offers_content;
      sendNotification(
        'Special Offers',
        message,
        ...
        <header className={styles.header}>
          ...
          <center>
            ...
            <Typography variant="h6" className={styles.messagetext}>
              Needs to trigger the Special Offers Notification. Users will get the Notification.
            </Typography>
