...
const Messages: React.FC = () => {
  const [activities, setActivities] = useState<AdminMessages[]>([]);
  ...
  const notifyEveryone = async (content_id: string) => {
    try {
      ...
      const message = response.data.messages_content;
      sendNotification(
        'Messages',
        message,
        ...
        <header className={styles.header}>
          ...
          <center>
            ...
            <Typography variant="h6" className={styles.messagetext}>
              Needs to trigger the Messages Notification. Users will get the Notification.
            </Typography>
